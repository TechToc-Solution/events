...
class GroupDetailsPageBoyd extends StatelessWidget {
  const GroupDetailsPageBoyd({super.key, required this.widget, required this.groupDetails});

  final GroupDetailPage widget;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SelectionIndicator(numOfSelection: widget.numOfSelection),
        ...
        CustomButton(
          onPressed: () {},
          child: Text("accept_selection".tr(context), style: Styles.textStyle16.copyWith(color: Colors.white)),
        ),
      ],
    );
  }
