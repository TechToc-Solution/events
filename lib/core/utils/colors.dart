...
class AppColors {
  ...
  static const Color primaryColors = Color.fromARGB(255, 110, 48, 1);
  static const Color secColors = Color.fromARGB(255, 255, 251, 202);
  static const Color borderColors = Color.fromARGB(255, 255, 208, 114);
