...
import 'package:events/features/group_details/data/repo/player_selection_repo_iplm.dart';
...
void setupLocatorServices() {
  ...
  getit.registerSingleton<PlayerSelectionRepo>(PlayerSelectionRepoIplm(apiServices: getit.get<ApiServices>()));

  getit.registerFactory<GetGroupDetailsCubit>(() => GetGroupDetailsCubit(getit.get<GroupRepo>()));
  getit.registerFactory<PlayerSelectionCubit>(
    () => PlayerSelectionCubit(playerSelectionRepo: getit.get<PlayerSelectionRepo>()),
  );
}
